...
@section('content')
    ...
    <section class="landing-page d-flex flex-column justify-content-center align-items-center position-relative z-3 vh-100 overflow-hidden">
        ...
        <div class="container text-center" data-aos="fade-up">
            ...
            <a href="{{url('/products')}}" class="btn btn-lg btn-primary fs-4 rounded-pill px-5">إدفع الآن</a>
            <div class="d-flex align-items-center justify-content-center mt-4">
                <img src="{{asset('images/cib.svg')}}" alt="CIB" width="60" class="me-4">
                <img src="{{asset('images/AlgeriePoste.svg')}}" alt="Edahabia" width="60">
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        function checkNavBarColor () {
            ...
            const heroSection = document.querySelector('.landing-page');

            if(this.scrollY >= heroSection.clientHeight - 81) {
